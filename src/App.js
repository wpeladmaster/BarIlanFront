...
const App = () => {
  ...
  const loginRequest = { scopes: ["user_impersonation", "email", "openid", "User.Read"] };
      ...
      try {
        ...
        try {
          const tokenResponse = await instance.acquireTokenSilent({
            scopes: ["user_impersonation", "email", "openid", "User.Read"]
          });
  ...
  const handleLogin = async () => {
    try {
      ...
      const token = (await instance.acquireTokenSilent({ scopes: ["user_impersonation", "email", "openid", "User.Read"] })).accessToken;
