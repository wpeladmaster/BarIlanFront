...
const App = () => {
  ...
  const loginRequest = { scopes: ["email", "openid", "User.Read", "api://user_impersonation/.default"] };
      ...
      try {
        ...
        try {
          const tokenResponse = await instance.acquireTokenSilent({
            scopes: ["email", "openid", "User.Read", "api://user_impersonation/.default"]
          });
  ...
  const handleLogin = async () => {
    try {
      ...
      const token = (await instance.acquireTokenSilent({ scopes: ["email", "openid", "User.Read", "api://user_impersonation/.default"] })).accessToken;
