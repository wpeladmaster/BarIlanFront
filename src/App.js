...
const App = () => {
  ...
  const loginRequest = { scopes: ["email", "openid", "profile", "User.Read", "User.Read.All", "User.ReadBasic.All"] };
  ...
  const handleLogin = async () => {
    try {
      ...
      const token = (await instance.acquireTokenSilent({ scopes: ["email", "openid", "profile", "User.Read", "User.Read.All", "User.ReadBasic.All"] })).accessToken;
