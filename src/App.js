...
const App = () => {
  ...
  const loginRequest = { scopes: ["email", "Group.Read.All", "GroupMember.Read.All", "openid", "profile", "User.Read", "User.Read.All", "User.ReadBasic.All"] };
      ...
      try {
        ...
        try {
          const tokenResponse = await instance.acquireTokenSilent({
            scopes: ["email", "Group.Read.All", "GroupMember.Read.All", "openid", "profile", "User.Read", "User.Read.All", "User.ReadBasic.All"]
          });
  ...
  const handleLogin = async () => {
    try {
      ...
      const token = (await instance.acquireTokenSilent({ scopes: ["email", "Group.Read.All", "GroupMember.Read.All", "openid", "profile", "User.Read", "User.Read.All", "User.ReadBasic.All"] })).accessToken;
